...
7. Go to [FlashXML.net](http://www.flashxml.net/ "Free Flash Components") and [customize your 3D Carousel Menu FX](http://www.flashxml.net/3d-carousel-menu.html "3D Carousel Menu FX") using the Live Demo. Generate the `settings.xml` text and use it to overwrite `flashxml/carouselmenufx/settings.xml`
8. To use your own images, upload them to the `flashxml/carouselmenufx/images` folder and update the `flashxml/carouselmenufx/images.xml` file accordingly
